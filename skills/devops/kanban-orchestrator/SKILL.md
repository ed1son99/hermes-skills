...
triggers: [kanban-orchestrator, kanban, multi-agent, orchestration, routing, decomposition, the, don, rule and the basic lifecycle are auto-injected into every kanban worker]
