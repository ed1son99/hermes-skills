...
triggers: [llama-cpp, llama.cpp, gguf, quantization, hugging face hub, cpu inference, apple silicon, edge deployment, amd gpus, intel gpus, nvidia, url-first, hf hub]
